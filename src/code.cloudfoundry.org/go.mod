...
require (
	...
	code.cloudfoundry.org/guardian v0.0.0-20250806021341-ef3063efe1fe
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/ecr v1.48.0 // indirect
	github.com/aws/aws-sdk-go-v2/service/ecrpublic v1.35.0 // indirect
