...
require (
	...
	code.cloudfoundry.org/certsplitter v0.51.0
	...
	code.cloudfoundry.org/diego-logging-client v0.55.0
	code.cloudfoundry.org/dockerdriver v0.50.0
	code.cloudfoundry.org/durationjson v0.41.0
