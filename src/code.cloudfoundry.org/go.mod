...
require (
	...
	code.cloudfoundry.org/bbs v1.4.0
	...
	code.cloudfoundry.org/routing-info v1.1.0
...
require (
	...
	github.com/buildpacks/lifecycle v0.21.6 // indirect
	github.com/buildpacks/pack v0.40.2 // indirect
