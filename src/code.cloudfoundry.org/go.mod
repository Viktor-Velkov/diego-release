...
require (
	...
	code.cloudfoundry.org/go-diodes v0.0.0-20250819102816-d2f6d525a844 // indirect
	...
	github.com/aws/aws-sdk-go-v2/service/ecr v1.49.1 // indirect
	github.com/aws/aws-sdk-go-v2/service/ecrpublic v1.36.1 // indirect
