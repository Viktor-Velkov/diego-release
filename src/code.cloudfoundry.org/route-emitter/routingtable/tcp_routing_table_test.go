		...
		Describe("Swap", func() {
			...
			It("emits routing events for new routes", func() {
				...
				Expect(routingEvents.Registrations).Should(ConsistOf(
					tcpmodels.NewTcpRouteMapping("router-group-guid", 61000, "some-ip-1", 62004, 61443, "instance-guid-1", nil, nil, 0, tcpmodels.ModificationTag{}, false, ""),
					tcpmodels.NewTcpRouteMapping("router-group-guid", 61000, "some-ip-2", 62004, 61443, "instance-guid-2", nil, nil, 0, tcpmodels.ModificationTag{}, false, ""),
				))
			})
			...
			Context("when the table is configured to emit direct instance route", func() {
				...
				It("emits routing events for new routes", func() {
					...
					Expect(routingEvents.Registrations).Should(ConsistOf(
						tcpmodels.NewTcpRouteMapping("router-group-guid", 61000, "container-ip-1", 5222, 5443, "instance-guid-1", nil, nil, 0, tcpmodels.ModificationTag{}, false, ""),
						tcpmodels.NewTcpRouteMapping("router-group-guid", 61000, "container-ip-2", 5222, 5443, "instance-guid-2", nil, nil, 0, tcpmodels.ModificationTag{}, false, ""),
					))
				})
		...
		Describe("AddRoutes", func() {
			...
			Context("existing external port changes", func() {
				...
				It("emits routing event with modified external port, HostTLSPort and InstanceId", func() {
					...
					Expect(routingEvents.Registrations).Should(ConsistOf(
						tcpmodels.NewTcpRouteMapping("router-group-guid", 61001, "some-ip-1", 62004, 61443, "instance-guid-1", nil, nil, 0, tcpmodels.ModificationTag{}, false, ""),
						tcpmodels.NewTcpRouteMapping("router-group-guid", 61001, "some-ip-2", 62004, 61443, "instance-guid-2", nil, nil, 0, tcpmodels.ModificationTag{}, false, ""),
					))
			...
			Context("new external port is added", func() {
				...
				It("emits routing event with both external ports", func() {
					...
					Expect(routingEvents.Registrations).Should(ConsistOf(
						tcpmodels.NewTcpRouteMapping("router-group-guid", 61001, "some-ip-1", 62004, 61443, "instance-guid-1", nil, nil, 0, tcpmodels.ModificationTag{}, false, ""),
						tcpmodels.NewTcpRouteMapping("router-group-guid", 61001, "some-ip-2", 62004, 61443, "instance-guid-2", nil, nil, 0, tcpmodels.ModificationTag{}, false, ""),
						tcpmodels.NewTcpRouteMapping("router-group-guid", 61002, "some-ip-1", 62004, 61443, "instance-guid-1", nil, nil, 0, tcpmodels.ModificationTag{}, false, ""),
						tcpmodels.NewTcpRouteMapping("router-group-guid", 61002, "some-ip-2", 62004, 61443, "instance-guid-2", nil, nil, 0, tcpmodels.ModificationTag{}, false, ""),
					))
			...
			Context("multiple external port added and multiple existing external ports deleted", func() {
				...
				It("emits routing event with both external ports", func() {
					...
					Expect(routingEvents.Registrations).Should(ConsistOf(
						tcpmodels.NewTcpRouteMapping("router-group-guid", 61002, "some-ip-1", 62004, 61443, "instance-guid-1", nil, nil, 0, tcpmodels.ModificationTag{}, false, ""),
						tcpmodels.NewTcpRouteMapping("router-group-guid", 61002, "some-ip-2", 62004, 61443, "instance-guid-2", nil, nil, 0, tcpmodels.ModificationTag{}, false, ""),
						tcpmodels.NewTcpRouteMapping("router-group-guid", 61003, "some-ip-1", 62004, 61443, "instance-guid-1", nil, nil, 0, tcpmodels.ModificationTag{}, false, ""),
						tcpmodels.NewTcpRouteMapping("router-group-guid", 61003, "some-ip-2", 62004, 61443, "instance-guid-2", nil, nil, 0, tcpmodels.ModificationTag{}, false, ""),
					))
			...
			Context("when TLS is disabled", func() {
				...
				It("emits empty InstanceId and 0 for HostTLSPort", func() {
					...
					Expect(routingEvents.Unregistrations).Should(ConsistOf(
						tcpmodels.NewTcpRouteMapping("router-group-guid", 61000, "some-ip-1", 62004, -1, "", nil, nil, 0, tcpmodels.ModificationTag{}, false, ""),
						tcpmodels.NewTcpRouteMapping("router-group-guid", 61000, "some-ip-2", 62004, -1, "", nil, nil, 0, tcpmodels.ModificationTag{}, false, ""),
					))

					Expect(routingEvents.Registrations).Should(ConsistOf(
						tcpmodels.NewTcpRouteMapping("router-group-guid", 61001, "some-ip-1", 62004, -1, "", nil, nil, 0, tcpmodels.ModificationTag{}, false, ""),
						tcpmodels.NewTcpRouteMapping("router-group-guid", 61001, "some-ip-2", 62004, -1, "", nil, nil, 0, tcpmodels.ModificationTag{}, false, ""),
					))
			...
			Context("when two disjoint (external port, container port) pairs are given", func() {
				...
				It("emits two separate registration events with no overlap", func() {
					...
					Expect(routingEvents.Registrations).Should(ConsistOf(
						tcpmodels.NewTcpRouteMapping("router-group-guid", 61001, "some-ip-1", 62004, 61443, "instance-guid-1", nil, nil, 0, tcpmodels.ModificationTag{}, false, ""),
						tcpmodels.NewTcpRouteMapping("router-group-guid", 61002, "some-ip-1", 63004, 61443, "instance-guid-1", nil, nil, 0, tcpmodels.ModificationTag{}, false, ""),
					))
		...
		Describe("Updating routes", func() {
			...
			Context("when there is no change in container ports", func() {
				...
				Context("existing router group guid changes", func() {
					...
					It("emits unregistration and registration mappings", func() {
						...
						Expect(routingEvents.Registrations).Should(ConsistOf(
							tcpmodels.NewTcpRouteMapping("new-router-group-guid", 61000, "some-ip-1", 62004, 61443, "instance-guid-1", nil, nil, 0, tcpmodels.ModificationTag{}, false, ""),
						))
				...
				Context("when mapped to new external port", func() {
					...
					Context("existing backends for new container port", func() {
						...
						It("emits registration events for new container port", func() {
							...
							routingEvents, _ := routingTable.SetRoutes(logger, beforeLRP, afterLRP)
							Expect(routingEvents.Registrations).Should(ConsistOf(
								tcpmodels.NewTcpRouteMapping("router-group-guid", 61001, "some-ip-1", 62006, 61443, "instance-guid-2", nil, nil, 0, tcpmodels.ModificationTag{}, false, ""),
							))
					...
					Context("no backends for new container port", func() {
						...
						Context("when the actual lrp is updated", func() {
							...
							It("emits two registration events", func() {
								Expect(routingEvents.Registrations).Should(ConsistOf(
									tcpmodels.NewTcpRouteMapping("router-group-guid", 61000, "some-ip-1", 62004, 61443, "instance-guid-1", nil, nil, 0, tcpmodels.ModificationTag{}, false, ""),
									tcpmodels.NewTcpRouteMapping("router-group-guid", 61001, "some-ip-1", 62005, 62443, "instance-guid-1", nil, nil, 0, tcpmodels.ModificationTag{}, false, ""),
								))
							})
						})
				...
				Context("when container port is switched", func() {
					...
					Context("existing backends for new container port", func() {
						...
						It("emits registration events for new container port", func() {
							...
							Expect(routingEvents.Registrations).Should(ConsistOf(
								tcpmodels.NewTcpRouteMapping("router-group-guid", 61000, "some-ip-1", 62006, 61443, "instance-guid-1", nil, nil, 0, tcpmodels.ModificationTag{}, false, ""),
							))
							Expect(routingEvents.Unregistrations).Should(ConsistOf(
								tcpmodels.NewTcpRouteMapping("router-group-guid", 61000, "some-ip-1", 62004, 61443, "instance-guid-1", nil, nil, 0, tcpmodels.ModificationTag{}, false, ""),
							))
			...
			Context("when an existing route is removed", func() {
				...
				It("emits an unregistration event and keeps the other route", func() {
					...
					Expect(routingEvents.Unregistrations).Should(ConsistOf(
						tcpmodels.NewTcpRouteMapping("router-group-guid", 62000, "some-ip-1", 62004, 61443, "instance-guid-1", nil, nil, 0, tcpmodels.ModificationTag{}, false, ""),
					))
					Expect(routingTable.TCPAssociationsCount()).Should(Equal(1))
				})
			})
		...
		Describe("RemoveRoutes", func() {
			...
			Context("when entry does have endpoints", func() {
				...
				It("emits unregistration routing events", func() {
					...
					Expect(routingEvents.Unregistrations).To(HaveLen(1))
					Expect(routingEvents.Unregistrations).Should(ConsistOf(
						tcpmodels.NewTcpRouteMapping("router-group-guid", 61000, "some-ip-1", 61000, 61443, "instance-guid-1", nil, nil, 0, tcpmodels.ModificationTag{}, false, ""),
					))
					Expect(routingTable.TCPAssociationsCount()).Should(Equal(0))
				})
		...
		Describe("AddEndpoint", func() {
			Context("with no existing endpoints", func() {
				...
				It("emits routing events", func() {
					...
					Expect(routingEvents.Registrations).Should(ConsistOf(
						tcpmodels.NewTcpRouteMapping("router-group-guid", 61000, "some-ip-1", 61104, 61443, "instance-guid-1", nil, nil, 0, tcpmodels.ModificationTag{}, false, ""),
					))
					Expect(routingTable.TCPAssociationsCount()).Should(Equal(1))
				})
			})
			...
			Context("with existing endpoints", func() {
				...
				Context("with different instance guid", func() {
					It("emits routing events", func() {
						...
						routingEvents, _ := routingTable.AddEndpoint(logger, actualLRP)
						Expect(routingEvents.Registrations).Should(ConsistOf(
							tcpmodels.NewTcpRouteMapping("router-group-guid", 61000, "some-ip-3", 61104, 61443, "instance-guid-3", nil, nil, 0, tcpmodels.ModificationTag{}, false, ""),
						))
				...
				Context("with same instance guid", func() {
					Context("newer modification tag", func() {
						It("emits routing events", func() {
							...
							routingEvents, _ := routingTable.AddEndpoint(logger, actualLRP)
							Expect(routingEvents.Registrations).Should(ConsistOf(
								tcpmodels.NewTcpRouteMapping("router-group-guid", 61000, "some-ip-1", 61105, 61443, "instance-guid-1", nil, nil, 0, tcpmodels.ModificationTag{}, false, ""),
							))
							Expect(routingTable.TCPAssociationsCount()).Should(Equal(2))
						})
					})
					...
					Context("when TLS port of actual LRP is updated", func() {
						It("emits unregistration for old route and registration for new route", func() {
							...
							Expect(routingEvents.Registrations).Should(ConsistOf(
								tcpmodels.NewTcpRouteMapping("router-group-guid", 61000, "some-ip-1", 62004, 62443, "instance-guid-1", nil, nil, 0, tcpmodels.ModificationTag{}, false, ""),
							))
						})
					})
				})
		...
		Describe("Swap", func() {
			...
			Context("when adding a new routing key (process-guid, container-port)", func() {
				...
				It("overwrites the existing entries and emits registration and unregistration routing events", func() {
					...
					Expect(routingEvents.Registrations).Should(ConsistOf(
						tcpmodels.NewTcpRouteMapping("router-group-guid", 61000, "some-ip-3", 63004, 61443, "instance-guid-1", nil, nil, 0, tcpmodels.ModificationTag{}, false, ""),
						tcpmodels.NewTcpRouteMapping("router-group-guid", 61000, "some-ip-4", 63004, 61443, "instance-guid-2", nil, nil, 0, tcpmodels.ModificationTag{}, false, ""),
					))
				})
			})
			...
			Context("when updating the router group guid", func() {
				...
				It("emits registration and unregistration events", func() {
					...
					Expect(routingEvents.Registrations).Should(ConsistOf(
						tcpmodels.NewTcpRouteMapping("new-router-group-guid", 61000, "some-ip-1", 62004, 61443, "instance-guid-1", nil, nil, 0, tcpmodels.ModificationTag{}, false, ""),
						tcpmodels.NewTcpRouteMapping("new-router-group-guid", 61000, "some-ip-2", 62004, 61443, "instance-guid-2", nil, nil, 0, tcpmodels.ModificationTag{}, false, ""),
					))
					Expect(routingEvents.Unregistrations).Should(ConsistOf(
						tcpmodels.NewTcpRouteMapping("router-group-guid", 61000, "some-ip-1", 62004, 61443, "instance-guid-1", nil, nil, 0, tcpmodels.ModificationTag{}, false, ""),
						tcpmodels.NewTcpRouteMapping("router-group-guid", 61000, "some-ip-2", 62004, 61443, "instance-guid-2", nil, nil, 0, tcpmodels.ModificationTag{}, false, ""),
